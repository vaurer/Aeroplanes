...
CargoPlane cargoPlane1 = new CargoPlane("Beluga A300-600 ST", 155000, 86500, 23860, 0);
Airliner airliner1 = new Airliner("Airbus A380-800", 575000, 277000, 253983, 0,519);
